            ...
            <div className="relative w-full py-12 animate-fade-in-up">
                ...
                <div className="relative z-10 text-center">
                    ...
                    <h1 className="text-3xl md:text-5xl font-black tracking-tight leading-tight mb-6 text-white uppercase italic">
                        Global Alert And <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 not-italic">Reporting Feed</span>
                    </h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto border-t border-slate-800/60 pt-10">
                        <div className="bg-slate-950/40 p-6 rounded-[2rem] border border-slate-800 shadow-xl backdrop-blur-md transition-all hover:border-slate-700 group">
                            <div className="text-4xl font-black text-white mb-2 group-hover:scale-110 transition-transform">{alerts.length}</div>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {alerts.length > 0 ? (
                            ...
                            <div className="col-span-full py-20 text-center bg-slate-900/50 rounded-2xl border border-slate-800 backdrop-blur-sm flex flex-col items-center">
                                <p className="text-slate-500 text-lg font-medium tracking-wide">No active global alerts reported at this time.</p>
                                <div className="mt-4 text-xs font-mono text-slate-600 uppercase tracking-widest">Scanning International Streams...</div>
                            </div>
                        )}
                    </div>
                )}
